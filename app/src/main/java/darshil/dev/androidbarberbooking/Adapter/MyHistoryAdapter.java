...
public class MyHistoryAdapter extends RecyclerView.Adapter<MyHistoryAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        myViewHolder.txt_booking_barber_text.setText(bookingInformationList.get(i).getBarberName());
        ...
        myViewHolder.txt_salon_name.setText(bookingInformationList.get(i).getSalonName());
        myViewHolder.txt_booking_date.setText(bookingInformationList.get(i).getTime());
